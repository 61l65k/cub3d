...
/*   Updated: 2024/05/25 04:52:27 by apyykone         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
const char* mlx42_strerror(mlx_errno_t val);
 ...
 * @returns True or false if the key is down or not.
 */
bool mlx42_is_key_down(mlx_t* mlx, keys_t key);
 ...
 * @param[in] param An additional optional parameter.
 */
void mlx42_key_hook(mlx_t* mlx, mlx_keyfunc func, void* param);
 ...
 */
bool mlx42_loop_hook(mlx_t* mlx, void (*f)(void*), void* param);
 ...
 */
mlx_texture_t* mlx42_load_png(const char* path);
 ...
 */
void mlx42_put_pixel(mlx_image_t* image, uint32_t x, uint32_t y, uint32_t color);
 ...
 */
mlx_image_t* mlx42_put_string(mlx_t* mlx, const char* str, int32_t x, int32_t y);
 ...
 */
const mlx_texture_t* mlx42_get_font(void);
 ...
 */
int32_t mlx42_get_texoffset(char c);
